...
import { RhythmCircle } from "../index.js"
import Rhythm from "rhythmicon-rhythm"

const mountComponent = props => mount(RhythmCircle, { props })

describe("RhythmCircle", () => {
  it("renders with rhythm Array", () => {
    const circle = mountComponent({ rhythm: [1, 0, 1, 0] })
  ...
  it("renders with Rhythm object", () => {
    const circle = mountComponent({ rhythm: new Rhythm([1, 0, 1, 0]) })
    expect(circle.find("svg").exists()).toBe(true)
  })
